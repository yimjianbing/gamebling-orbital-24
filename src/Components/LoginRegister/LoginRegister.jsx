        ...
        <div className ={`wrapper${action}`}>
            <div className="form-box login">
                <form action="">
                    ...
                    <button className="login-register-button" type="submit" onClick={login}>Login</button>
            ...
            <div className="form-box register">
                <form action="">
                    ...
                    <button className="login-register-button"type="submit" onClick={register}>Register</button>
